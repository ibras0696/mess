      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        <header className="flex flex-col gap-4 rounded-2xl border border-white/10 bg-white/5 p-6 shadow-xl backdrop-blur">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-slate-300">
                Спринт 1: подняли Vite + React + Tailwind, разложили структуру под SPA, WS и REST клиент.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <StatusPill title="Auth" detail="Экран логина/регистрации в макете" />
            <StatusPill title="REST" detail="Клиент сгенерим по OpenAPI" />
